...
func (r *IngressReconciler) syncOperatorStatus() {
	...
	if err = r.client.Update(context.TODO(), co); err != nil {
...
func (r *IngressReconciler) getOperatorState() (*corev1.Namespace, []ingressv1alpha1.ClusterIngress, []appsv1.DaemonSet, error) {
	...
	err = r.client.List(context.TODO(), &client.ListOptions{}, ingressList)
	if err != nil {
		return nil, nil, nil, fmt.Errorf(
	...
	err = r.client.List(context.TODO(), &client.ListOptions{}, daemonsetList)
	if err != nil {
		return nil, nil, nil, fmt.Errorf(
